      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed max-w-sm">
              Connecting talented professionals with outstanding opportunities. Your next big project or star employee is just a click away.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-slate-200 dark:border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-500 dark:text-slate-500 font-medium">
            &copy; {new Date().getFullYear()} Masterrio. All rights reserved.
          </p>
          <div className="flex text-xs space-x-4 text-slate-400 dark:text-slate-500">
            <span className="cursor-pointer hover:text-primary-600 dark:hover:text-primary-400 transition-colors">Privacy Policy</span>
            <span className="cursor-pointer hover:text-primary-600 dark:hover:text-primary-400 transition-colors">Terms of Service</span>
            <span className="cursor-pointer hover:text-primary-600 dark:hover:text-primary-400 transition-colors">Cookie Settings</span>
          </div>
        </div>
      </div>
    </footer>
